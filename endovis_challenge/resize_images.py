...
root = '/content/drive/Shareddrives/TFM_Clara/6_robot-surgery-segmentation-master/data/train_data/train_masks/*.png'

def main():
  files_train = glob.glob('/content/drive/Shareddrives/TFM_Clara/6_robot-surgery-segmentation-master/data/train_data/video39_masks/*.png')
  files_train.sort()
